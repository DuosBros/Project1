...
import { Button, Modal, Form, Grid, Dropdown, Checkbox, Table } from 'semantic-ui-react';
...
class AddEditPurchaseModal extends React.PureComponent {
    ...
    handleSavePurchase = () => {
        ...
        // {"products":[{"productName":"Glycolic Facial Scrub 120ml","count":1},{"productName":"Hyaluronic Serum 120ml","count":1},{"productName":"","count":1}],"to":"hlasenska@medpharma.cz","user":"admin"}
    }

    handleSupplerDropdownOnChange = (e, m) => {
                ...
                <Grid.Row verticalAlign='middle' className="paddingTopAndBottomSmall">
                    ...
                    <Grid.Column width={11}>
                        <Dropdown
                            ...
                            onChange={this.handleSupplerDropdownOnChange}
                            fluid
                            selection
